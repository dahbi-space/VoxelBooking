<?php
/**
 * 403 Forbidden — rendered inside the admin shell.
 * Shows sidebar + topbar so the user can navigate away.
 */
$activePage = '';
ob_start();
?>
<div style="display:flex;align-items:center;justify-content:center;min-height:60vh;text-align:center;">
    <div style="max-width:400px;padding:2rem;">
        <div style="color:var(--vb-admin-warning);margin-bottom:1.5rem;">
            <!-- Lucide lock -->
        ...
        <div style="font-size:3rem;font-weight:700;letter-spacing:-0.05em;color:var(--vb-admin-text-tertiary);margin-bottom:0.5rem;">403</div>
        <h2 style="font-size:var(--vb-text-xl);font-weight:600;margin-bottom:0.5rem;">Access denied</h2>
        <p style="font-size:var(--vb-text-base);color:var(--vb-admin-text-secondary);margin-bottom:2rem;">You don't have permission to view this page.</p>
