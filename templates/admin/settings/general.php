...
<div class="vb-grid" style="gap: 1.5rem; grid-template-columns: 1fr 1fr;">
    ...
    <div class="vb-card vb-fade-in-up stagger-1">
        <div class="vb-card-header">
            <div class="vb-card-title">Application</div>
            <div class="vb-card-desc">Core application configuration.</div>
        </div>
        <form method="POST" action="/admin/settings">
            <input type="hidden" name="_csrf_token" value="<?= htmlspecialchars($csrfToken, ENT_QUOTES, 'UTF-8') ?>">

            <div class="vb-form-group">
                <label for="app_name" class="vb-label">Application name</label>
            ...
            <div class="vb-form-group">
                <label for="app_url" class="vb-label">Application URL</label>
            ...
            <div class="vb-form-row">
                <div class="vb-form-group">
                    <label for="timezone" class="vb-label">Timezone</label>
                ...
                <div class="vb-form-group">
                    <label for="date_format" class="vb-label">Date format</label>
    ...
    <div class="vb-card vb-fade-in-up stagger-2">
        <div class="vb-card-header">
            <div class="vb-card-title">System Information</div>
            <div class="vb-card-desc">Runtime environment and version details.</div>
        </div>
