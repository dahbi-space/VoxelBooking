 ...
 */
$actionLabels = [
    'auth.login' => ['label' => __('admin.audit.action_auth_login'), 'color' => 'var(--vb-admin-text-success)'],
    'auth.login_failed' => ['label' => __('admin.audit.action_auth_login_failed'), 'color' => 'var(--vb-admin-text-error)'],
    'auth.logout' => ['label' => __('admin.audit.action_auth_logout'), 'color' => 'var(--vb-admin-text-secondary)'],
    'auth.password_changed' => ['label' => __('admin.audit.action_auth_password_changed'), 'color' => 'var(--vb-brand-primary)'],
    'auth.brute_force_detected' => ['label' => __('admin.audit.action_auth_brute_force'), 'color' => 'var(--vb-admin-text-error)'],
    'auth.access_denied' => ['label' => __('admin.audit.action_auth_access_denied'), 'color' => 'var(--vb-admin-text-error)'],
    'settings.updated' => ['label' => __('admin.audit.action_settings_updated'), 'color' => 'var(--vb-brand-primary)'],
    'booking.created' => ['label' => __('admin.audit.action_booking_created'), 'color' => 'var(--vb-admin-text-success)'],
    'booking.cancelled' => ['label' => __('admin.audit.action_booking_cancelled'), 'color' => 'var(--vb-admin-text-error)'],
    'booking.rescheduled' => ['label' => __('admin.audit.action_booking_rescheduled'), 'color' => 'var(--vb-brand-primary)'],
    'booking.status_changed' => ['label' => __('admin.audit.action_booking_status_changed'), 'color' => 'var(--vb-brand-primary)'],
    'customer.anonymized' => ['label' => __('admin.audit.action_customer_anonymized'), 'color' => 'var(--vb-admin-text-warning, #f59e0b)'],
    'privacy.request_received' => ['label' => __('admin.audit.action_privacy_request_received'), 'color' => 'var(--vb-admin-text-warning, #f59e0b)'],
    'privacy.request_completed' => ['label' => __('admin.audit.action_privacy_request_completed'), 'color' => 'var(--vb-admin-text-success)'],
    'data.export_generated' => ['label' => __('admin.audit.action_data_export'), 'color' => 'var(--vb-brand-primary)'],
    'api_key.created' => ['label' => __('admin.audit.action_api_key_created'), 'color' => 'var(--vb-admin-text-warning, #f59e0b)'],
    'api_key.revoked' => ['label' => __('admin.audit.action_api_key_revoked'), 'color' => 'var(--vb-admin-text-secondary)'],
    'system.audit_cleanup' => ['label' => __('admin.audit.action_system_audit_cleanup'), 'color' => 'var(--vb-admin-text-secondary)'],
    'system.migration' => ['label' => __('admin.audit.action_system_migration'), 'color' => 'var(--vb-admin-text-secondary)'],
    'retention.executed' => ['label' => __('admin.audit.action_retention_executed'), 'color' => 'var(--vb-admin-text-secondary)'],
    'role.changed' => ['label' => __('admin.audit.action_role_changed'), 'color' => 'var(--vb-admin-text-warning, #f59e0b)'],
    'rate_limit.exceeded' => ['label' => __('admin.audit.action_rate_limit_exceeded'), 'color' => 'var(--vb-admin-text-error)'],
    'tenant.created' => ['label' => __('admin.audit.action_tenant_created'), 'color' => 'var(--vb-admin-text-success)'],
    'tenant.archived' => ['label' => __('admin.audit.action_tenant_archived'), 'color' => 'var(--vb-admin-text-secondary)'],
];
