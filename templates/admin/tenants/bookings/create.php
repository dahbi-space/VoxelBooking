            ...
            <div class="vb-form-grid">
                <div class="vb-form-row">
                    <div class="vb-form-group">
                        ...
                        <select id="create_service_id" name="service_id" class="vb-input w-full" required
                    ...
                    <div class="vb-form-group">
                        ...
                        <select id="create_staff_id" name="staff_id" class="vb-input w-full"
                ...
                <div class="vb-form-row">
                    <div class="vb-form-group">
                        ...
                        <input type="date" id="create_date" name="date" class="vb-input w-full" required
                    ...
                    <div class="vb-form-group">
                        ...
                        <select id="create_time" name="time" class="vb-input w-full" required
