...
<body>
    ...
    <div class="login-panel">
        <button type="button" class="login-theme-toggle" id="theme-toggle" aria-label="Toggle theme">
                ...
                <form method="POST" action="/admin/login" id="login-form">
                    ...
                    <div class="vb-form-group login-field-1">
                        ...
                        <div class="vb-input-wrap">
                            ...
                            <input type="email" id="email" name="email" class="vb-input vb-input-icon" placeholder="operator@example.com" required autocomplete="email" autofocus>
                        </div>
                    </div>
