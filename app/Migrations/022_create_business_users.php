...
/**
 * Migration 022: Create business_users table.
 *
 * Per PRD §VI and .ai/21-VoxelBooking-Roles-Checklist.md:
 * Business users belong to a tenant with role 'owner' or 'manager'.
 * Operators manage business users via the admin panel.
 *
 * Auth engine already queries this table (Auth::login checks business_users
 * after operators). This migration creates the actual table.
 */
return [
